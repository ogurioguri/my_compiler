...
public class divideLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FormatStringleft", "FormatStringmid", "FormatStringright", "Void", "Int", 
			"Bool", "String", "New", "Class", "Null", "This", "True", "False", "If", 
			"Else", "While", "For", "Break", "Continue", "Return", "Plus", "Minus", 
			"Star", "Div", "Mod", "Equal", "NotEqual", "Less", "LessEqual", "Greater", 
			"GreaterEqual", "And", "Or", "Not", "RightShift", "LeftShift", "BitAnd", 
			"BitOr", "BitXor", "BitNot", "Assign", "PlusPlus", "MinusMinus", "Dot", 
	...
	public divideLexer(CharStream input) {
		super(input);
