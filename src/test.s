...
main_for.cond0:
      ...
      lw      t0, 0(t1)
      sw      t0, 36(sp)
      # %__tmp.2 = load i32, ptr %_n.0
      lw      t1, 0(sp)
      lw      t0, 0(t1)
      sw      t0, 40(sp)
      # %__tmp.3 = icmp sle i32 %__tmp.1, %__tmp.2
      lw      t1, 36(sp)
      lw      t2, 40(sp)
      sub     t0, t1, t2
      sltz    t3, t0
...
main_jump0:
      j       main_for.merge0
main_for.body0:
      # %__tmp.4 = load i32, ptr %_j.0
      lw      t1, 24(sp)
      lw      t0, 0(t1)
      sw      t0, 48(sp)
      # store i32 1, ptr %_j.0
      li      t0, 1
      lw      t1, 24(sp)
      sw      t0, 0(t1)
      # br label %for.cond1
      j       main_for.cond1
main_for.cond1:
      # %__tmp.5 = load i32, ptr %_j.0
      lw      t1, 24(sp)
      lw      t0, 0(t1)
      sw      t0, 52(sp)
      # %__tmp.6 = load i32, ptr %_n.0
      lw      t1, 0(sp)
      lw      t0, 0(t1)
      sw      t0, 56(sp)
      # %__tmp.7 = icmp sle i32 %__tmp.5, %__tmp.6
      lw      t1, 52(sp)
      lw      t2, 56(sp)
      sub     t0, t1, t2
      sltz    t3, t0
      ...
      mv      t0, t2
      sw      t0, 60(sp)
      # br i1 %__tmp.7, label %for.body1, label %for.merge1
      lw      t0, 60(sp)
      beqz     t0, main_jump1
      j       main_for.body1
main_jump1:
      j       main_for.merge1
main_for.body1:
      # %__tmp.8 = load i32, ptr %_sum.0
      lw      t1, 8(sp)
      lw      t0, 0(t1)
      sw      t0, 64(sp)
      # %__tmp.9 = load i32, ptr %_sum.0
      lw      t1, 8(sp)
      lw      t0, 0(t1)
      sw      t0, 68(sp)
      # %__tmp.10 = load i32, ptr %_i.0
      lw      t1, 16(sp)
      lw      t0, 0(t1)
      sw      t0, 72(sp)
      # %__tmp.11 = add i32 %__tmp.9, %__tmp.10
      lw      t1, 68(sp)
      lw      t2, 72(sp)
      add     t0, t1, t2
      sw      t0, 76(sp)
      # store i32 %__tmp.11, ptr %_sum.0
      lw      t0, 76(sp)
      lw      t1, 8(sp)
      sw      t0, 0(t1)
      # br label %for.step1
      j       main_for.step1
main_for.step1:
      # %__tmp.12 = load i32, ptr %_j.0
      lw      t1, 24(sp)
      lw      t0, 0(t1)
      sw      t0, 80(sp)
      # %__tmp.13 = add i32 %__tmp.12, 1
      li      t2, 1
      lw      t1, 80(sp)
      add     t0, t1, t2
      sw      t0, 84(sp)
      # store i32 %__tmp.13, ptr %_j.0
      lw      t0, 84(sp)
      lw      t1, 24(sp)
      sw      t0, 0(t1)
      # br label %for.cond1
      j       main_for.cond1
main_for.merge1:
      # %__tmp.14 = load i32, ptr %_sum.0
      lw      t1, 8(sp)
      lw      t0, 0(t1)
      sw      t0, 88(sp)
      # %__tmp.15 = load i32, ptr %_sum.0
      lw      t1, 8(sp)
      lw      t0, 0(t1)
      sw      t0, 92(sp)
      # %__tmp.16 = add i32 %__tmp.15, 1
      li      t2, 1
      lw      t1, 92(sp)
      add     t0, t1, t2
      sw      t0, 96(sp)
      # store i32 %__tmp.16, ptr %_sum.0
      lw      t0, 96(sp)
      lw      t1, 8(sp)
      sw      t0, 0(t1)
      # br label %for.step0
      j       main_for.step0
main_for.step0:
      # %__tmp.17 = load i32, ptr %_i.0
      lw      t1, 16(sp)
      lw      t0, 0(t1)
      sw      t0, 100(sp)
      # %__tmp.18 = add i32 %__tmp.17, 1
      li      t2, 1
      lw      t1, 100(sp)
      add     t0, t1, t2
      sw      t0, 104(sp)
      # store i32 %__tmp.18, ptr %_i.0
      lw      t0, 104(sp)
      lw      t1, 16(sp)
      sw      t0, 0(t1)
      # br label %for.cond0
